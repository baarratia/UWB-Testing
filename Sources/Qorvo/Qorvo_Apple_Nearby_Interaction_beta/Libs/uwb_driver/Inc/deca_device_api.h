...
#define RX_SFD_HLDOFF 0x20000000UL  //Number of symbols of accumulation to wait before checking for an SFD pattern.
...
#define DWT_TIME_UNITS (1.0 / 499.2e6 / 128.0) //!< = 15.65e-12 s
    ...
    typedef enum
    {
        ...
        DWT_DW3720_PDOA_DEV_ID = (int)(0xDECA0314)  //!< DW3720 (with PDOA) silicon device ID
    } dw_chip_id_e;

#define DELAY_20uUSec       (20) /*Delay of 20uSec(measured 24uSec)*/
#define MAX_RETRIES_FOR_PLL (20) /*The PLL calibration should take less than 400us, typically it is < 100us*/
...
#define STS_LEN_128BIT       (16)
    ...
    typedef struct
    {
        ...
        uint32_t D;                   // the DGC_DECISION, treated as an unsigned integer in range 0 to 7.
